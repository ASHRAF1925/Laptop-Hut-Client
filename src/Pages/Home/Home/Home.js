...
const Home = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://laptop-hut-server.vercel.app/postforSell/products")
      .then((res) => {
  ...
  return (
    <div>
      ...
      <div class="item" data-aos="flip-up">
        {" "}
        <h1 className="text-3xl text-center font-bold mb-5 mx-auto">
          Select From the Categoris
        </h1>
          ...
          {allcategoris.map((category) => (
            <>
              <button
                ...
                className="btn btn-primary inline mx-4 mt-5"
              >
                {category.brandName}
              </button>
            </>
      ...
      <div class="item" data-aos="flip-left">
        ...
        <div className="mx-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-8 ">
          <div className="card w-96 bg-base-100 shadow-xl image-full">
            <figure>
              <img
                src="https://images.unsplash.com/photo-1518091043644-c1d4457512c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1031&q=80"
                alt="Shoes"
              />
            </figure>
          ...
          <div className="card w-96 bg-base-100 shadow-xl image-full">
            <figure>
              <img
                src="https://images.unsplash.com/photo-1569831479215-14d8616fd81d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80 "
                alt="Shoes"
              />
            </figure>
            <div className="card-body">
          ...
          <div className="card w-96 bg-base-100 shadow-xl image-full">
            <figure>
              <img
                src="https://images.unsplash.com/photo-1564034503-e7c9edcb420c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
                alt="Shoes"
              />
            </figure>
            <div className="card-body">
      ...
      <div class="item" data-aos="fade-down">
        <div class="item mt-20 " data-aos="zoom-out">
          <h1 className="text-3xl  bg-lime-300 w-3/5 mx-auto p-10 rounded-lg">
            User Comments
          </h1>

          <CommentItem reviews={comments}></CommentItem>
        </div>
      </div>
      {/* Our services  */}
      <div className="divider"></div>
        ...
        <div class="flex min-h-screen pt-[30px] px-[40px]">
          <div class="min-w-full">
            ...
            <div class="mt-[20px] grid grid-cols-3 gap-[20px]">
              <div
                key="1"
                class="w-full bg-[#fff] rounded-[10px] shadow-[0px 1px 2px #E1E3E5] border border-[#E1E3E5] divide-y"
              >
              ...
              >
                ...
                <div class="pt-[25px] px-[25px] pb-[35px]">
                  ...
                  <div class="mt-[25px]">
                    <button class="bg-[#E1E3E5] rounded-[5px] py-[15px] px-[25px] text-[#fff] text-[14px] leading-[17px] font-semibold">
                      Current Plan
                    </button>
                  </div>
                </div>
      ...
      <div class="item" data-aos="zoom-in">
        <div class="antialiased bg-black w-full  text-slate-300 py-4 mx-auto text-center">
          <div class="grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
            <div
              id="content"
              class="bg-white/10 col-span-9 rounded-lg p-6 mx-auto"
            >
              <div id="24h">
                <h1 class="font-bold py-4 uppercase mx-auto">
                  Last 24h Statistics
                </h1>
                <div
                  id="stats"
                  class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mx-auto"
                >
                  <div class="bg-black/60 to-white/5 p-6 rounded-lg mx-auto">
