...
const AllSellers = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold text-center mb-10">This are the Sellers</h1>
        ...
        <div key={seller._id}>
          <div className="card w-96 bg-base-100 shadow-xl">
            ...
            <div className="card-body">
              ...
              {seller.isverified && <div className="bg-green-600 text-white"> verified</div>}
              {!seller.isverified && <div className="bg-red-600 text-white"> not verified</div>}
              <button
